# LeSysBot Windows Tools (official)

Official collection of **Windows tool packages** for
[LeSysBot](https://github.com/lesysbot/lesysbot). Each subdirectory of `tools/` is a
self-contained tool package (`README.md` + `tool.py`) — `CLITool` wrappers
around Windows commands, or Windows-only `@tool` code. LeSysBot's core repo
...
macOS: [lesysbot-macos-tools-official](https://github.com/lesysbot/lesysbot-macos-tools-official).)

## Install

```powershell
# Offers every package in this repo
lesysbot tools install lesysbot/lesysbot-windows-tools-official

# Install a single package
lesysbot tools install lesysbot/lesysbot-windows-tools-official/tools/network
```

Or copy any package folder into your `~/.lesysbot/tools/` and restart LeSysBot.
...
A tool whose OS or required binary isn't satisfied still registers in LeSysBot,
...
See LeSysBot's [writing-tools](https://github.com/lesysbot/lesysbot/blob/main/docs/writing-tools.md)
and [sharing-tools](https://github.com/lesysbot/lesysbot/blob/main/docs/sharing-tools.md)
guides for how these packages work.

## Contributing with Claude Code

This repo is wired for [Claude Code](https://code.claude.com/docs): open it and
trust the folder, and you'll be offered LeSysBot's **`lesysbot-tool-dev`** plugin,
...
Details: [Writing Tools with Claude Code](https://github.com/lesysbot/lesysbot/blob/main/docs/claude-code.md).
